...
<div className="text-center font-weight-bold flex-1">{data.slice(75,84)}</div>
<div className="text-center font-weight-bold flex-1">{data.slice(84,85)=="2" ? "OK" : (data.slice(84,85)=="1" ? "NG" : "")}</div>
